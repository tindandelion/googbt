...
public class AuctionSniperEndToEndTest {
    private int STOP_PRICE = 5000;
    private final FakeAuctionServer auction = new FakeAuctionServer(new Item("item-54321", STOP_PRICE));
    private final FakeAuctionServer auction2 = new FakeAuctionServer(new Item("item-65432", STOP_PRICE));
    private final ApplicationRunner application = new ApplicationRunner();


    @Test
    public void sniperJoinsAuctionAndLosesWithoutBidding() throws Exception {
    ...
    @Test
    public void sniperReportsInvalidMessageAndStopsRespondingToEvents() throws Exception {
        ...
        application.reportInvalidMessage(auction, brokenMessage);
        application.showsSniperHasFailed(auction);
    }
